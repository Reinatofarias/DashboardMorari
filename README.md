...
- KPIs principais: CPM, CTR, CPC, CPL, Custo por Landing Page View, CPA, ROAS, Valor de Conversao e Quantidade de Compras.
- Graficos interativos com Chart.js.
- Tabela diaria com os dados retornados pela API.
- Filtros por nivel: campanha, conjunto de anuncio e anuncio.
